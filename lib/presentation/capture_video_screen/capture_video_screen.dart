...
class CaptureVideoScreen extends StatelessWidget {CaptureVideoScreen({Key? key}) : super(key: key);
...
/// Section Widget
PreferredSizeWidget _buildAppBar(BuildContext context) { return CustomAppBar(height: 50.v, actions: [AppbarTrailingIconbutton(imagePath: ImageConstant.imgFrame30x30, margin: EdgeInsets.symmetric(horizontal: 24.h), onTap: () {onTapIconButton(context);})]); } 
/// Section Widget

...
class HmtSixtyScreen extends StatelessWidget {
  HmtSixtyScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: _buildOpenHouse(
              context,
              dynamicText: "Front Squat",
            ),
          ),
          SizedBox(height: 8.v),
          Padding(

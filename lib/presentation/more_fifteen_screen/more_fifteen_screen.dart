...
class MoreFifteenScreen extends StatelessWidget {
  const MoreFifteenScreen({Key? key})
      : super(
          key: key,
        );
        ...
        children: [
          ...
          Padding(
            ...
            child: _buildLunch(
              context,
              lunchText: "Breakfast",
              tasteScoreText: "Taste Score: N/A",
              satietyScoreText: "Satiety Score: N/A",
            ),
          ),
          Spacer(),
          SizedBox(
  ...
  Widget _buildLunch(
    ...
    required String tasteScoreText,
    required String satietyScoreText,
  }) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
